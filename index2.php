...
#export-tb td:nth-child(3){width:40px;}
#flag-tb td:nth-child(3){width:40px;}
textarea{width:100%;min-height:20px;border-radius:4px;webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);border: 1px solid #ccc;   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s; box-shadow: inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;}


#module-tb td:nth-child(2){width:40px;}
	</style>
  </head>
		...
		<div class="panel panel-primary">
            ...
            <div class="panel-body">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="Command-Line" aria-describedby="basic-addon1">
				</div>
            </div>
          </div>
		  <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><b>Modules</b> 
				<img onclick="addModule();" style="cursor:pointer;width:23px;height:23px;vertical-align:bottom;" src="add.png"/>
				</h3>
            </div>
            <div class="panel-body">
				<table id="module-tb">
					<tr>
						...
						<td><img style="cursor:pointer;width:23px;height:23px;vertical-align:bottom;" src="copy.png"/></td>
					</tr>
				</table>
		  ...
		  <div class="panel panel-info">
            <div class="panel-heading">
			  ...
			  <img onclick="addExport();" style="cursor:pointer;width:23px;height:23px;vertical-align:bottom;" src="add.png"/>
			  </h3>
            </div>
            <div class="panel-body">
				<table id="export-tb">
		  ...
		  <div class="panel panel-warning">
            <div class="panel-heading">
			  ...
			  <img onclick="addFlag();" style="cursor:pointer;width:23px;height:23px;vertical-align:bottom;" src="add.png"/>
			  </h3>
            </div>
            <div class="panel-body">
				<table id="flag-tb">
		  ...
		  <button type="button" class="btn btn-lg btn-success">Record</button>
